...
public class Exercise13_16 {
	...
	public static void main(String[] args) {
		...
		String[] str = (equation.replaceAll(" ", "/")).split("/");

		BigInteger numerator1 = new BigInteger(str[0]);
		BigInteger denominator1 = new BigInteger(str[1]);
		BigInteger numerator2 = new BigInteger(str[3]);
		BigInteger denominator2 = new BigInteger(str[4]);
